                        ...
                        <div class="row-span">
                            <div class="w-40 h-40 mx-auto">
                                <img class="rounded-full border border-gray-100 shadow-sm mx-2" src=
                                    "https://avatars.githubusercontent.com/u/69432454?v=4" alt="user image" />
                            </div>
                        </div>
                        <div class="row-span">
