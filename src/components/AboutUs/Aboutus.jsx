            ...
            <div className="grid grid-cols-9 gap-4">
                    ...
                    <div className="grid grid-flow-rows grid-rows my-3 gap-4">
                        <div class="row-span">
                            <div class="w-40 h-40 mx-auto">
                                <img class="rounded-full border border-gray-100 shadow-sm mx-2" 
                            ...
                            <div className="grid grid-flow-cols mx-auto gap-4">
                                ...
                                <div className="row-span mx-auto px-3">
                                    <div className="container border-2 border-blue-700 rounded-lg text-white px-3 py-1">
                                        <p class="text-blue-700 text-lg">Description</p>
                                        <p class="text-blue-700 text-md">Tech Geek, Problem solver, AI/ML enthusiast, JAVA developer, Frontend developer</p>
                                    </div>
                                </div>
                                <div className="row-span mx-auto">
                ...
                <div className="col-span-9 md:col-span-3 max-h-1/4 bg-yellow-300 border-b-8 border-r-8 shadow-lg border-purple-700 rounded-md" style={{ minHeight: '30vh' }}>
                    <div class="relative w-40 h-40" align="center">
                        &nbsp;
                        <img class="rounded-full border border-gray-100 shadow-sm" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVLqfekg_kitC_QJ5kgBUTh2tt5EIcxEnQDQ&usqp=CAU" alt="user image" />
                    </div>
                    &nbsp;&nbsp;&nbsp;
                    <div>
                        <h4>Akshad Thole</h4>
