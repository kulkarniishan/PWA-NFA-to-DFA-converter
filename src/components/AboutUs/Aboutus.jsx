    ...
    return (
        <div className='min-h-screen text-white p-10 transition duration-500 dark:bg-gray-700'>
            <div className="grid grid-cols-9 gap-4">
                <div className="col-span-9 md:col-span-3 max-h-1/4 bg-blue-300 border-b-8 border-r-8 shadow-lg border-green-700 rounded-md " style={{ minHeight: '30vh' }}>
                    <div className="grid grid-flow-rows grid-rows my-3 gap-4">
                        <div className="row-span">
                            <div className="w-40 h-40 mx-auto">
                                <img className="rounded-full border border-gray-100 shadow-sm mx-2"
                            ...
                            <div className="grid grid-flow-cols mx-auto gap-4">
                                ...
                                <div className="row-span mx-auto px-3">
                                    <div className="container border-2 border-blue-700 rounded-lg text-white px-3 py-1">
                                        ...
                                        <p className="text-blue-700 text-md">Tech Geek, Problem solver, AI/ML enthusiast, JAVA developer, Frontend developer</p>
                                    </div>
                                </div>
                                <div className="row-span mx-auto">
                ...
                <div className="col-span-9 md:col-span-3 max-h-1/4 bg-red-300 border-b-8 border-r-8 shadow-lg border-pink-700 rounded-md " style={{ minHeight: '30vh' }}>
                    <div className="grid grid-flow-rows grid-rows my-3 gap-4">
                        <div className="row-span">
                            <div className="w-40 h-40 mx-auto">
                                <img className="rounded-full border border-gray-100 shadow-sm mx-2" src=
                                    "https://avatars.githubusercontent.com/u/69432454?v=4"
                                    alt="Ishan"
                                />
                            </div>
                        </div>
                            ...
                            <div className="grid grid-flow-cols mx-auto gap-4">
                                ...
                                <div className="row-span mx-auto px-3">
                                    <div className="container border-2 border-red-700 rounded-lg  px-3 py-1">
                                        ...
                                        <p className="text-red-700 text-md">Geek. Problem solver MERN stack enthusiast. ML developer</p>
                                    </div>
                                </div>
                                <div className="row-span mx-auto">
                                    <div className="container hover:bg-blue-400 bg-blue-600 rounded-lg text-lg  px-4 py-1 ">
                            ...
                            <div className="grid grid-flow-cols mx-auto gap-4">
                                ...
                                <div className="row-span mx-auto px-3">
                                    <div className="container border-2 border-yellow-700 rounded-lg  px-3 py-1">
                                        ...
                                        <p className="text-yellow-700 text-md">A passionate Full Stack Software Developer 🚀 and Machine Learning Enthusiast 🤖 having an experience of building Web and Mobile applications</p>
                                    </div>
                                </div>
                                <div className="row-span mx-auto">
                                    <div className="container hover:bg-blue-400 bg-blue-600 rounded-lg text-lg  px-4 py-1 ">
